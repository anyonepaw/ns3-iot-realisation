 ...
 */
    ...
    public:
        ...
        Block (int blockHeight, int minerId, int parentBlockMinerId = 0, int blockSizeBytes = 0,
               double timeCreated = 0, std::map<int, blockDataTuple> blockDataMap = std::map<int, blockDataTuple>(), double timeReceived = 0, Ipv4Address receivedFromIpv4Address = Ipv4Address("0::0::0::0"));
        Block ();
        ...
        Ipv4Address GetReceivedFromIpv4Address (void) const;
        void SetReceivedFromIpv4Address (Ipv4Address receivedFromIpv4Address);
    ...
    protected:
        ...
        Ipv4Address m_receivedFromIpv4Address;       // The Ipv4Address of the node which sent the block to the receiving node
