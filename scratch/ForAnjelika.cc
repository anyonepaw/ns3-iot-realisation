...
main (int argc, char *argv[])
{
    ...
    address2.SetBase("10.0.1.1", "255.255.255.0");

    Ipv4AddressHelper address3;
    address3.SetBase("10.0.2.1", "255.255.255.0");

    Ipv4AddressHelper address4;
    address4.SetBase ("10.0.3.1", "255.255.255.0");

    Ipv4AddressHelper address5;
    address5.SetBase ("10.0.4.1", "255.255.255.0");

    Ipv4AddressHelper address6;
    address6.SetBase("10.0.5.1", "255.255.255.0");

    Ipv4AddressHelper address7;
    address7.SetBase ("10.0.6.1", "255.255.255.0");

    Ipv4AddressHelper address8;
    address8.SetBase ("10.0.7.1", "255.255.255.0");
    ...
    Ipv4Address firstNode1Address = firstInterfaces.GetAddress(0);
    Ipv4Address secondNode1Address = firstInterfaces.GetAddress(1);
    Ipv4Address firstNode2Address = secondInterfaces.GetAddress(0);
    Ipv4Address secondNode2Address = secondInterfaces.GetAddress(1);
    Ipv4Address firstNode3Address = thirdInterfaces.GetAddress(0);
    Ipv4Address secondNode3Address = thirdInterfaces.GetAddress(1);
    Ipv4Address firstNode4Address = fourthInterfaces.GetAddress(0);
    Ipv4Address secondNode4Address = fourthInterfaces.GetAddress(1);
    Ipv4Address firstNode5Address = fifthInterfaces.GetAddress(0);
    Ipv4Address secondNode5Address = fifthInterfaces.GetAddress(1);
    Ipv4Address firstNode6Address = sixthInterfaces.GetAddress(0);
    Ipv4Address secondNode6Address = sixthInterfaces.GetAddress(1);
    Ipv4Address firstNode7Address = seventhInterfaces.GetAddress(0);
    Ipv4Address secondNode7Address = seventhInterfaces.GetAddress(1);
    Ipv4Address firstNode8Address = eighthInterfaces.GetAddress(0);
    Ipv4Address secondNode8Address = eighthInterfaces.GetAddress(1);

    addNat(node1, firstNode1Address, secondNode8Address);
    addNat(node2, firstNode2Address, secondNode1Address);
    addNat(node3, firstNode3Address, secondNode2Address);
    addNat(node4, firstNode4Address, secondNode3Address);
    addNat(node5, firstNode5Address, secondNode4Address);
    addNat(node6, firstNode6Address, secondNode5Address);
    addNat(node7, firstNode7Address, secondNode6Address);
    addNat(node8, firstNode8Address, secondNode7Address);
    ...
    ApplicationContainer client = tcpClient.Install(node5);
    client.Start(Seconds(2.0));
    client.Stop(Seconds(12.0));

    TcpEchoClientHelper tcpClient1(fifthInterfaces.GetAddress(0), 9);
    ...
    ApplicationContainer client1= tcpClient1.Install(node1);
    client1.Start(Seconds(2.15));
    client1.Stop(Seconds(12.0));



    TcpEchoServerHelper tcpServer(9);
    ApplicationContainer server = tcpServer.Install(node7);
